...
async def start_uploading(data):
    ...
    try:
        ...
        filed = filed.replace("Go.Go.Loser.Ranger.S01E01.We.Are.Justice.The.Dragon.Keepers.1080p.DSNP.WEB-DL.AAC2.0.H.264-VARYG", "[AniDL] Sentai Daishikkaku - 01 [Web][1080p x265 10Bit][AAC][DSNP ~ VARYG]")
        filed = filed.replace("Go.Go.Loser.Ranger.S01E02.Go.Fighter.D.1080p.DSNP.WEB-DL.AAC2.0.H.264-VARYG", "[AniDL] Sentai Daishikkaku - 02 [Web][1080p x265 10Bit][AAC][DSNP ~ VARYG]")
        filed = filed.replace("Go.Go.Loser.Ranger.S01E04.The.Soldier.With.Love.Hibiki.1080p.DSNP.WEB-DL.AAC2.0.H.264-VARYG", "[AniDL] Sentai Daishikkaku - 04 [Web][1080p x265 10Bit][AAC][DSNP ~ VARYG]")
